package com.forms.backend.config;
...
import com.forms.backend.services.CustomUserDetailsService;
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(authz -> authz
                                                .requestMatchers( "/api/auth/**","/api/ppeco/**","/api/fi-economicas/**","/api/variables","/api/mdea/**").permitAll()
